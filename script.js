const translations = {
  en: {
    ...
    coursesTitle: "Core coursework at FAU.",
    cm1Title: "Control Engineering",
    cm1Meta: "Vertiefung",
    cm1Note: "From classical PID through state-space and Lyapunov stability into robot kinematics and nonlinear observers — the long process of really understanding how to make a system behave.",
    cm2Title: "Computer Science & AI",
    cm2Meta: "Currently learning",
    cm2Note: "Filling in the math and engineering chain of ML/DL from scratch. The goal is to combine it with my control background and do learning-based control.",
    cm3Title: "Engineering Fundamentals",
    cm3Meta: "Technical",
    cm3Note: "From semiconductors on one end to production lines on the other — a complete engineering view of how a robot actually gets built.",
  ...
  de: {
    ...
    navCourses: "Kurse",
    coursesLabel: "Kurse",
    coursesTitle: "Kernveranstaltungen an der FAU.",
    cm1Title: "Regelungstechnik",
    cm1Meta: "Vertiefung",
    cm1Note: "Vom klassischen PID über Zustandsraum und Lyapunov-Stabilität bis hin zu Roboterkinematik und nichtlinearen Beobachtern — der lange Weg, um wirklich zu verstehen, wie man ein System dazu bringt, sich zu verhalten.",
    cm2Title: "Informatik & KI",
    cm2Meta: "Lerne ich gerade",
    cm2Note: "Ich arbeite die mathematische und technische Kette von ML/DL von Grund auf durch. Ziel: sie mit meinem Regelungs-Hintergrund zu verbinden und learning-based control zu betreiben.",
    cm3Title: "Technische Grundlagen",
    cm3Meta: "Technisch",
    cm3Note: "Von Halbleitern auf der einen Seite bis zu Fertigungslinien auf der anderen — ein vollständiger ingenieurmäßiger Blick darauf, wie ein Roboter tatsächlich gebaut wird.",
  ...
  zh: {
    ...
    navCourses: "课程",
    coursesLabel: "课程",
    coursesTitle: "在 FAU 学过的核心课程。",
    cm1Title: "控制工程",
    cm1Meta: "Vertiefung",
    cm1Note: "从经典 PID 到状态空间、Lyapunov 稳定性，再到机器人运动学和非线性观测器——把如何让一个系统按预期运动这件事彻底搞懂的过程。",
    cm2Title: "计算机与 AI",
    cm2Meta: "正在学习",
    cm2Note: "正在从手撕梯度开始补齐 ML/DL 的数学和工程链路。目标是把它和我的控制经验结合，做 learning-based control。",
    cm3Title: "工程基础",
    cm3Meta: "技术",
    cm3Note: "从微观的半导体到宏观的生产线——让我对一台机器人是如何被造出来的有完整的工程视角。",
    introLine: "个人主页",
    heroGreeting: "你好，我是",
    heroName: "杨定帅",
    heroDomain1: "机器人",
  ...
  ja: {
    ...
    navCourses: "授業",
    coursesLabel: "Courses",
    coursesTitle: "FAU で履修した主な授業。",
    cm1Title: "制御工学",
    cm1Meta: "Vertiefung",
    cm1Note: "古典 PID から状態空間、Lyapunov 安定性、ロボット運動学、非線形オブザーバーまで — 系をいかに望ましく振る舞わせるかを本当に理解するまでの長い道のり。",
    cm2Title: "情報科学 & AI",
    cm2Meta: "学習中",
    cm2Note: "ML/DL の数学と工学のチェーンをゼロから埋めています。目標は制御の経験と組み合わせて、learning-based control に取り組むこと。",
    cm3Title: "工学の基礎",
    cm3Meta: "技術",
    cm3Note: "半導体からプロダクションラインまで — ロボットがどう作られるのかを工学的に俯瞰する視点を与えてくれた科目。",
    introLine: "個人サイト",
    heroGreeting: "こんにちは、",
    heroName: "ディンシュアイ・ヤン",
    heroDomain1: "ロボティクス",
