const translations = {
  en: {
    ...
    projectsTitle: "Labs and interactive experiments.",
    demo1Title: "Pendulum-Cart Visualizer",
    demo1Meta: "Interactive demo · self-built",
    ...
    demo2Meta: "Interactive demo · self-built",
    ...
    demo5Meta: "Path planning · Python source",
    ...
    demo6Meta: "Path planning · Python source",
  ...
  de: {
    ...
    profileTitle: "Mechatronikstudent mit Fokus auf Robotik und Regelungstechnik",
    ...
    projectsTitle: "Laborarbeit und interaktive Experimente.",
    demo1Title: "Pendel-Wagen-Visualizer",
    demo1Meta: "Interaktive Demo · selbst gebaut",
    ...
    demo2Meta: "Interaktive Demo · selbst gebaut",
    ...
    demo5Title: "RRT — Rapidly-exploring Random Tree",
    demo5Meta: "Pfadplanung · Python-Quellcode",
    ...
    demo6Meta: "Pfadplanung · Python-Quellcode",
  ...
  zh: {
    ...
    viewProjects: "查看项目",
    contactMe: "联系我",
    profileTitle: "机器人与控制工程方向的机电一体化硕士学生",
    profileRole: "Friedrich-Alexander-Universität Erlangen-Nürnberg (FAU) · Erlangen, Germany",
    focusLabel: "关注方向",
    focusValue: "Robotics、Control Engineering、Computer Science、AI & LLMs",
    statusLabel: "当前学习",
  ...
  ja: {
    ...
    contactMe: "連絡する",
    profileTitle: "ロボティクスと制御工学に注力するメカトロニクス学生",
    profileRole: "Friedrich-Alexander-Universität Erlangen-Nürnberg (FAU) · Erlangen, Germany",
    focusLabel: "関心分野",
    focusValue: "Robotics、Control Engineering、Computer Science、AI & LLMs",
    statusLabel: "現在学習中",
